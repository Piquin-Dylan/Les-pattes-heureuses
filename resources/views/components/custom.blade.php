@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="mt-10 flex justify-center">

        <div class="flex items-center gap-2 rounded-3xl border border-[#E7DDD4] bg-white p-2 shadow-lg shadow-[#C67C47]/10">
