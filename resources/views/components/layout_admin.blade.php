...
<div class="flex min-h-screen">
    ...
    <aside
        ...
        class="fixed top-0 left-0 h-full w-64 bg-[#C67C47] shadow-xl z-40 transform transition duration-300 lg:translate-x-0">
        ...
        <nav class="h-full flex flex-col items-center justify-center">
            ...
            <ul class="flex flex-col gap-6 text-xl font-semibold w-full px-6">
    ...
    <div class="flex-1 flex flex-col lg:ml-64">
        ...
        <div class="bg-[#C67C47] h-16 flex items-center px-3 lg:px-4 shadow-md">
            ...
            <button
                class="relative z-50 lg:hidden shrink-0 text-white"
                @click="open = !open">
